...
source [file join $::app_sim_ui::library bsysbrowser.tcl        ]
...
source [file join $::app_sim_ui::library econtrol.tcl           ]
...
source [file join $::app_sim_ui::library sigeventbrowser.tcl    ]
