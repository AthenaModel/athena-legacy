#-----------------------------------------------------------------------
# TITLE:
#    old_strategybrowser.tcl
#
# AUTHORS:
#    Will Duquette
#
# DESCRIPTION:
#    old_strategybrowser(sim) package: Agent/Goal/Tactic browser/editor
#
# TBD:
# 
...
snit::widget old_strategybrowser {
    #-------------------------------------------------------------------
    # Type Constructor
    ...
    constructor {args} {
        ...
        notifier bind ::old_strategy <Check>   $self [mymethod ReloadOnEvent]
    ...
    method GTreeSanityCheck {} {
        if {[old_strategy checker] ne "OK"} {
            app show my://app/sanity/old_strategy
        }
    }
