...
tacticx define EXECUTIVE "Executive Command" {actor system} -onlock {
    #-------------------------------------------------------------------
    # Instance Variables
...
order define TACTICX:EXECUTIVE:UPDATE {
    ...
    prepare tactic_id -required -oneof [tacticx::EXECUTIVE ids]
