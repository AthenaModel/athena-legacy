...
source [file join $::app_sim_shared::library conditionx.tcl         ]
source [file join $::app_sim_shared::library conditionx_mood.tcl    ]
source [file join $::app_sim_shared::library conditionx_nbmood.tcl  ]
...
source [file join $::app_sim_shared::library strategyx.tcl          ]
...
source [file join $::app_sim_shared::library tacticx.tcl            ]
source [file join $::app_sim_shared::library tacticx_assign.tcl     ]
source [file join $::app_sim_shared::library tacticx_demob.tcl      ]
source [file join $::app_sim_shared::library tacticx_deploy.tcl     ]
source [file join $::app_sim_shared::library tacticx_deposit.tcl    ]
source [file join $::app_sim_shared::library tacticx_executive.tcl  ]
source [file join $::app_sim_shared::library tacticx_mobilize.tcl   ]
source [file join $::app_sim_shared::library tacticx_sigevent.tcl   ]
source [file join $::app_sim_shared::library tacticx_spend.tcl      ]
source [file join $::app_sim_shared::library tacticx_withdraw.tcl   ]
