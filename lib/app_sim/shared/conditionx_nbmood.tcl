...
conditionx define NBMOOD "Neighborhood Mood" {
    #-------------------------------------------------------------------
    # Instance Variables
...
# CONDITIONX:NBMOOD:UPDATE
#
# Updates the condition's parameters

order define CONDITIONX:NBMOOD:UPDATE {
    ...
    prepare condition_id -required -oneof [conditionx::NBMOOD ids]
