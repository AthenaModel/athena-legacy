...
tacticx define WITHDRAW "Withdraw Money" {actor} {
    #-------------------------------------------------------------------
    # Instance Variables
...
# TACTICX:WITHDRAW:UPDATE
#
# Updates existing WITHDRAW tactic.

order define TACTICX:WITHDRAW:UPDATE {
    ...
    prepare tactic_id  -required           -oneof [tacticx::WITHDRAW ids]
