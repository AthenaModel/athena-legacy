...
beanclass create strategyx

# NEXT, define class members
oo::objdefine strategyx {
    #-------------------------------------------------------------------
    ...
    method init {} {
        ...
        foreach agent [agent system names] {
            log normal strategyx "Creating strategy for agent $agent"
            my create_ $agent
        }
...
oo::define strategyx {
    ...
    method addblock_ {} {
        return [my addbean_ blocks [block new [self]]]
    }
...
order define STRATEGY:BLOCK:ADD {
    ...
    set s [strategyx getname $parms(agent)]
