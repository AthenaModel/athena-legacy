...
tacticx define SPEND "Spend Cash-On-Hand" {actor} -onlock {
    #-------------------------------------------------------------------
    # Instance Variables
...
order define TACTICX:SPEND:UPDATE {
    ...
    prepare tactic_id  -required -oneof [tacticx::SPEND ids]
