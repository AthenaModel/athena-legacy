...
source [file join $::app_sim::library cond_owner.tcl         ]
source [file join $::app_sim::library goal.tcl               ]
source [file join $::app_sim::library tactic.tcl             ]
source [file join $::app_sim::library tactic_types.tcl       ]
source [file join $::app_sim::library condition.tcl          ]
source [file join $::app_sim::library condition_types.tcl    ]
source [file join $::app_sim::library condition_goal.tcl     ]
...
source [file join $::app_sim::library personnelbrowser.tcl   ]
source [file join $::app_sim::library planforcebrowser.tcl   ]
source [file join $::app_sim::library schedulebrowser.tcl    ]
