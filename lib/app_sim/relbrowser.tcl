...
snit::widget relbrowser {
    ...
    constructor {args} {
        ...
        $tb insertcolumn end 0 {Relationship}
    ...
    # create id
    #
    # id      The {n f g} of a new rel curve.
    #
    # A new relisfaction curve has been created.  
    ...
    method EditSelected {} {
        ...
        if {[llength $ids] == 1} {
            ...
            ordergui enter RELATIONSHIP:UPDATE
            ordergui parm set n $n
            ordergui parm set f $f
            ordergui parm set g $g
        } else {
            ordergui enter RELATIONSHIP:UPDATE:MULTI
